                                  ...
                                  <td>
                                    ...
                                    <div class="form-group">
                                      <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" minlength="0" maxlength="3" min="0" max="3" pattern="[0-9]+" placeholder="0.00" id="descuentoGlobal" name=" descuentoGlobal" value="" placeholder=" Ingrese descuento">
                                      </div>
