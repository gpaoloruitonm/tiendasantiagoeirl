        ...
        <table class="table table-bordered dt-responsive tablas" width="100%">
          ...
          <tbody>
            ...
            ?>
              <tr>
                <td><?php echo ++$key; ?></td>
                <td><?php echo isset($value['nombre']) ? $value['nombre'] : ''; ?></td>
                <td><?php echo isset($value['dni']) ? $value['dni'] : ''; ?></td>
                <td><?php echo isset($value['email']) ? $value['email'] : ''; ?></td>
                <td><?php echo isset($value['telefono']) ? $value['telefono'] : ''; ?></td>
                <td><?php echo isset($value['direccion']) ? $value['direccion'] : ''; ?></td>
                <td><?php echo isset($value['fecha_nacimiento']) ? $value['fecha_nacimiento'] : ''; ?></td>
                <td><?php echo isset($value['total_compras']) ? $value['total_compras'] : ''; ?></td>
                <td><?php echo isset($value['ultima_compra']) ? $value['ultima_compra'] : ''; ?></td>
                <td><?php echo isset($value['ingreso_sistema']) ? $value['ingreso_sistema'] : ''; ?></td>
                <td>
                  <div class="btn-group">
